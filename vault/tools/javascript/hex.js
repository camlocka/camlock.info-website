...
Credits:
    ...
    - Tumblr images/icons:
        ...
        c) http://images.neon-sign.org/l-m/rose-flower-love-neon-sign.jpgtop
...
$(document).ready(() => {
  const links = [
    {
      name: 'steam',
      link: 'https://steamcommunity.com/id/mixedemotions/',
    },
    {
      name: 'insta',
      link: 'https://www.instagram.com/opsecwarrior/',
    },
    {
      name: 'contact via email',
      link: 'https://mail.google.com/mail/u/0/?fs=1&to=network@skidware.xyz&su=SUBJECT&body=BODY&bcc=&tf=cm',
    },
    {
      name: 'discord',
      link: 'https://discord.com/users/619942451196723209',
    },
    {
      name: 'telegram',
      link: 'https://t.me/transmute',
    },
  ];
  ...
  app.titleChanger(['n', 'n e', 'n e t', 'n e t', 'n e t w', 'n e t w o', 'n e t w o r', 'n e t w o r k']);
